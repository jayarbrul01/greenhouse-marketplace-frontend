...
export const translations = {
  en: {
    ...
    advertiseHere: "Advertise Here - Free",
    ...
    enterDescription: "Tell us about your business...",
    bannerImage: "Banner Image",
    submit: "Submit",
    submitting: "Submitting...",
    adSubmissionNote: "Your advertisement will be reviewed before being displayed on the site.",
  },
  es: {
    ...
    advertiseHere: "Anúnciate Aquí - Gratis",
    ...
    enterDescription: "Cuéntanos sobre tu negocio...",
    bannerImage: "Imagen del Banner",
    submit: "Enviar",
    submitting: "Enviando...",
    adSubmissionNote: "Tu anuncio será revisado antes de ser mostrado en el sitio.",
  },
  fr: {
    ...
    advertiseHere: "Annoncez Ici - Gratuit",
    ...
    description: "Description",
    enterDescription: "Parlez-nous de votre entreprise...",
    bannerImage: "Image de la Bannière",
    submit: "Soumettre",
    submitting: "Soumission...",
    adSubmissionNote: "Votre annonce sera examinée avant d'être affichée sur le site.",
  },
} as const;
